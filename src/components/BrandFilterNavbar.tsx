    ...
    return (
        isMobile ? (
            <div className={styles.brands_navbar} style={{ marginTop: "30px" }}>
                ...
                <SidebarMenu isOpen={isOpen} brand={brand} toggleSidebar={toggleSidebar} sidebarRef={sidebarRef} dataForDropDown={dataForDropDown} productsByBrandCategory={productsByBrandCategory} />
            </div>
        ) : (
